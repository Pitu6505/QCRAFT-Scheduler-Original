...
"Espia3" : "https://raw.githubusercontent.com/Pitu6505/QCRAFT-Scheduler-Original/refs/heads/Comprobacion-de-Circuitos-Malware/CircuitosGenerados/Espia/circuito_espia_3.py"
}
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for name, url_value in urls.items():
            ...
            data["url"] = url_value
            if name == "qft5":
                data["mitigation"] = "randomized_compiling"
